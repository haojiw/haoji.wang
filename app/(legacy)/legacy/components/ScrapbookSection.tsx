  ...
  const stickers: Sticker[] = [
    {
      id: 1,
      label: "Lexus",
      imageSrc: "/legacy/stickers/lexus.webp",
      rotate: "rotate(-2deg)",
      tilt: "rotate(-3deg)",
    ...
    },
    {
        id: 2,
        label: "Guitar",
        imageSrc: "/legacy/stickers/guitar.webp",
        rotate: "rotate(4deg)",
        tilt: "rotate(2deg)",
    ...
    },
    {
        id: 3,
        label: "Cooking",
        imageSrc: "/legacy/stickers/cooking.webp",
        rotate: "rotate(1deg)",
        tilt: "rotate(-3deg)",
    ...
    },
    {
        id: 12,
        label: "Teenage",
        imageSrc: "/legacy/stickers/teenage.webp",
        rotate: "rotate(1deg)",
        tilt: "rotate(2deg)",
    ...
    },
    {
        id: 5,
        label: "Sports",
        imageSrc: "/legacy/stickers/sports.webp",
        rotate: "rotate(-2deg)",
        tilt: "rotate(-2deg)",
    ...
    },
    {
        id: 9,
        label: "Math",
        imageSrc: "/legacy/stickers/math.webp",
        rotate: "rotate(-1deg)",
        tilt: "rotate(3deg)",
    ...
    },
    {
      id: 4,
      label: "Album",
      imageSrc: "/legacy/stickers/album.webp",
      rotate: "rotate(3deg)",
      tilt: "rotate(2deg)",
    ...
    },
    {
        id: 11,
        label: "Faith",
        imageSrc: "/legacy/stickers/faith.webp",
        rotate: "rotate(2deg)",
        tilt: "rotate(-2deg)",
    ...
    },
    {
        id: 8,
        label: "Books",
        imageSrc: "/legacy/stickers/books.webp",
        rotate: "rotate(-4deg)",
        tilt: "rotate(2deg)",
    ...
    },
    {
        id: 10,
        label: "Films",
        imageSrc: "/legacy/stickers/films.webp",
        rotate: "rotate(-2deg)",
        tilt: "rotate(3deg)",
    ...
    },
    {
      id: 7,
      label: "Globe",
      imageSrc: "/legacy/stickers/globe.webp",
      rotate: "rotate(3deg)",
      tilt: "rotate(-4deg)",
    ...
    },
    {
      id: 6,
      label: "Games",
      imageSrc: "/legacy/stickers/games.webp",
      rotate: "rotate(0deg)",
      tilt: "rotate(3deg)",
    ...
    <section className="mt-16 mb-16">
      <div className="flex justify-center mb-12">
        <div className="
          ...
          bg-[url('/legacy/wooden-board.png')] bg-cover bg-center 
