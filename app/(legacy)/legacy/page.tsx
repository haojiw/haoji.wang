...
import { BLOGPOSTS, type BlogPost } from './_lib/blogposts';
    ...
    <PageTransition>
      ...
      <section className="border-b border-border py-6">
        <h2 className="text-4xl md:text-5xl text-accent font-serif font-normal mb-8 mt-16">
          <Link href="/legacy/blog" className="no-underline hover:no-underline">
            BLOG
          </Link>
        </h2>
      ...
      <section className="py-6">
        <h2 className="text-4xl md:text-5xl text-accent font-serif font-normal mb-8 mt-16">
          <Link href="/legacy/work" className="no-underline hover:no-underline">
            WORK
          </Link>
        </h2>
